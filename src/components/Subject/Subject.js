       ...
       <div className="card text-center container m-5">
           <div className="card-body">
             ...
             <div className='d-grid btn'>
                 <button  className="btn btn-info  p-4 m-2">{options[0]}</button>
                 <button  className="btn btn-info  p-4 m-2">{options[1]}</button>
                 <button  className="btn btn-info  p-4 m-2">{options[2]}</button>
                <button  className="btn btn-info  p-4 m-2">{options[3]}</button>

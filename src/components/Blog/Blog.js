...
const Blog = () => {
    return (
        <div className='m-5'>
            <section className='container'>
                <div className="card">
  <h2 className="card-header">What is the purpose of react router???</h2>
  <div className="card-body">
    <h5 className="card-title text-decoration-underline"><strong>Purpose of react router:</strong></h5>
  ...
  <h2 className="card-header">How does context api works???</h2>
  <div className="card-body">
    <h5 className="card-title text-decoration-underline"><strong>Context api works:</strong></h5>
    <p className="card-text"> 
